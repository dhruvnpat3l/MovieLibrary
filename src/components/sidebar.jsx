...
<nav class="fixed h-20 bottom-0 inset-x-0 bg-white shadow-[5px_-5px_10px_-0px_rgba(0,0,0,0.1)] flex justify-between text-sm  capitalize font-mono">
  ...
  <div href="#" class="font-semibold w-full block py-5 px-3 text-center hover:bg-blue-50 transition duration-300">
  ...
  <div href="#" class="font-semibold w-full block py-5 px-3 text-center hover:bg-blue-50">
